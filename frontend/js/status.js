 ...
 // getStub('/getLanding', function(results){
    ...
    $.each(results, function(index, rowObject){
      tableString += "<tr class='clickable-row'><td>" + rowObject.trng_reqst_nbr + "</td>" +
        "<td>" + rowObject.trng_cors_cost + "</td>" +
        "<td>" + rowObject.trng_reqst_immed_supv_apvl_flg + "</td><td>" + rowObject.trng_reqst_dept_hd_apvl_flg + "</td><td>" + rowObject.trng_reqst_vp_apvl_flg + "</td></tr>";

    });
    $('#statusTable').html(tableString);
